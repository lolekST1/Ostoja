...
src/
  ...
  sim/          czysty TypeScript symulacji, bez Phasera
                typy.ts tick.ts budynki.ts los.ts
dane/           liczby balansowe: budynki.json ulepszenia.json stale.json
narzedzia/      symuluj.ts — narzedzie do balansowania bez przegladarki
```
